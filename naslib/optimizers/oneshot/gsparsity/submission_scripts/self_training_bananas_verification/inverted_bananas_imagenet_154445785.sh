...
#SBATCH --output=naslib/optimizers/oneshot/gsparsity/submission_scripts/self_training_bananas_verification/slurm_logs/ImageNet16-120/slurm_ib_imagenet_1544457859_%j.out

...
#SBATCH --job-name=ib_cifar10_1544457859
#SBATCH --output=naslib/optimizers/oneshot/gsparsity/submission_scripts/self_training_bananas_verification_and_computational_factor/slurm_logs/cifar10/slurm_ib_cifar10_1544457859_%j.out

...
# Add the SimpleStateDict class definition here
class SimpleStateDict:
    """
    A simple wrapper for a dictionary to make it checkpointable by
    fvcore's Checkpointer, by providing state_dict and load_state_dict.
    """

...
from naslib.optimizers.oneshot.gsparsity.optimizer import GSparseOptimizer
...
class Inverted_Bananas_GsparseOptimizer(MetaOptimizer):
    ...
    Stage 2: Apply one-shot training on the reduced space
    """
    ...
    def __init__(self, config):
        ...
        # Create optimizers
        self.stage1_use_zcp = False
        self.stage2_use_zcp = False
        
        logger.info("Using standard Inverted BANANAS for stage 1")
        self.stage1_optimizer = Inverted_Bananas(stage1_config)
            
        logger.info("Using standard GSparsity for stage 2")
        self.stage2_optimizer = GSparseOptimizer(stage2_config)

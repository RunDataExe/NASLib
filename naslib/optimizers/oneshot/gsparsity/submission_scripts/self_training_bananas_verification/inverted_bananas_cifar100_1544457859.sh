...
#SBATCH --output=naslib/optimizers/oneshot/gsparsity/submission_scripts/self_training_bananas_verification/slurm_logs/cifar100/slurm_ib_cifar100_1544457859_%j.out

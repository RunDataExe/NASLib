...
#SBATCH --output=naslib/optimizers/oneshot/gsparsity/submission_scripts/self_training_bananas_verification/slurm_logs/cifar10/slurm_stib_cifar10_1544457859_%j.out

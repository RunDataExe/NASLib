...
class DARTSOptimizer(MetaOptimizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.config = config
        self.learning_rate = config.search.learning_rate
        self.momentum = config.search.momentum
        self.weight_decay = config.search.weight_decay
        self.grad_clip = config.search.grad_clip
        self.arch_learning_rate = config.search.arch_learning_rate
        self.arch_weight_decay = config.search.arch_weight_decay
    ...
    def adapt_search_space(
        self, search_space, dataset, scope=None, dataset_api=None, **kwargs
    ):
